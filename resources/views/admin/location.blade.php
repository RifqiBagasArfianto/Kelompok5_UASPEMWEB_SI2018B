                ...
                <div class="card">
                    <div class="card-body">
                        <div class="title" style="float: left">
                            ...
                            <h6 class="card-subtitle">Manage your Location List</h6>
                        </div>
                        <a href="#" data-toggle="modal" data-target="#m-add-location" style="float:right;" class="btn btn-sm btn-success">Add Location</a>
                    </div>
                    <div class="card-body">
                                            ...
                                            <td style="text-align: center">
                                                <a class="nav-item dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-center user-dd animated">
                                                        <a class="dropdown-item" href="<?= URL::to('administrator/location/delete/'.$row->id) ?>"><i class="ti-trash m-r-5 m-l-5"></i> Delete</a>
                                                    </div>
                                                </a>
                                            </td>
                                        </tr>
...
<div class="modal fade" id="m-add-location" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  ...
  <form action="<?= URL::to('administrator/location/insert') ?>" enctype="multipart/form-data" method="post">
      @csrf
