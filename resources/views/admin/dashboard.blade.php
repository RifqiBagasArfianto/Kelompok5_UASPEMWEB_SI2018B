            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title m-b-5">User</h5>
                                <h3 class="font-light"><?= $user ?></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title m-b-5">Service</h5>
                                <h3 class="font-light"><?= $service ?></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title m-b-5">Order</h5>
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title m-b-5">Invoice</h5>
                                <h3 class="font-light"><?= $invoice ?></h3>
                            </div>
                        </div>
                    </div>
                </div>
