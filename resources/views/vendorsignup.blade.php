...
<section id="discount-product" class="discount-product" style="padding-top: 100px">
	<div class="container">
		<div class="row">
			<div class="col-lg-6">
				<div class="single-discount-product mt-30">
					<div class="product-image">
						<img src="<?= URL::to('/') ?>/assets/images/discount-product/product-1.jpg" alt="Product">
					</div> <!-- product image -->
			...
			<div class="col-lg-6">
				<form action="<?= URL::to('backend/vendor/register') ?>" method="POST">
					@csrf
					<div class="row">
						<div class="col-lg-6">
				...
				<div class="single-form form-group">
					<a href="<?= URL::to('signup') ?>" class="vendor-link">Register as User</a>
				</div>
			</div>
		</div> <!-- row -->
	</div> <!-- container -->
